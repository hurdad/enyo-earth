...
enyo.kind({
	...
	classes: "enyo-node",
	components: [
		{name: "checkbox", kind:"onyx.Checkbox", showing: false, onchange:"checkboxChanged"},
	...
	updateChanged: function() {
		this.$.checkbox.setValue(this.checkbox)
		if(this.checkbox !== undefined)
			this.$.checkbox.setShowing(true);
	},
	checkboxChanged: function(inSender, inEvent) {
		this.doCheckboxChanged({value: inSender.getValue()});
	},
